...
$SUBSCRIPTION_ID          = $global:SID
$LOCATION                 = "";
$BASE_URL                 = ""; # Specify this for marketplace deployments
...
$RESOURCE_GROUP_NAME_PREFIX = "<change-me-to-your-alias>"+"-"+"<what-are-you-testing?>"+"-"+(Get-Date ([TimeZoneInfo]::ConvertTime((Get-Date), [TimeZoneInfo]::UTC)) -UFormat %Y-%m-%d_%H.%M.%SZ-);
